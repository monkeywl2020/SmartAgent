...
from llama_index.core.indices.multi_modal import wlMultiModalVectorStoreIndex # 新增自定义的多模态索引类型 WL_MULTIMODAL_VECTOR_STORE
...
INDEX_STRUCT_TYPE_TO_INDEX_CLASS: Dict[IndexStructType, Type[BaseIndex]] = {
    ...
    IndexStructType.WL_MULTIMODAL_VECTOR_STORE: wlMultiModalVectorStoreIndex,# 新增自定义的多模态索引类型 WL_MULTIMODAL_VECTOR_STORE
}
