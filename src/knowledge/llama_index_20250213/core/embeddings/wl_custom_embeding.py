...
class wlEmbedding(BaseEmbedding):
    ...
    def __init__(self, 
                 ...
                 model_weight: str = "/models/bge-visualized/Visualized_m3.pth",
                 **kwargs: Any) -> None:
...
class wlMultiModalEmbedding(MultiModalEmbedding):
    ...
    def __init__(self, 
                 model_name: str = '/models/bge-m3',
                 model_weight: str = "/models/bge_visualized/Visualized_m3.pth",
                 **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self.model = Visualized_BGE(model_name_bge = model_name, model_weight = model_weight)
    ...
    def _get_query_embedding_with_img(self, query: Optional[str], query_img_file_path: Optional[ImageType]) -> Embedding:
